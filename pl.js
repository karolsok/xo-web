...
export default {
  ...
  tipCreateSnapshotLabel: 'Kliknij na guzik żeby stworzyć!',
  ...
  srStatePanel: 'Stan przestrzeni dyskowej',
  ...
  // Original text: "Storage Usage"
  srUsageStatePanel: 'Użycie przestrzeni dyskowej',
  ...
  noSelectedMetric: 'Nie wybrano metryki',
  ...
  newVmInstallSettingsPanel: 'Ustawienia instalacji',
  ...
  newVmBootAfterCreate: 'Uruchom VM po utworzeniu',
  ...
  xsTasks: 'Aktualnie, nie ma żadnych oczekujących zadań na Xenie',
  ...
  disclaimerText2: "Jeżeli jesteś firmą, lepiej używać produkcyjnej wersji z wsparciem:",

  // Original text: "This version is not bundled with any support nor updates. Use it with caution for critical tasks."
  disclaimerText3: 'Ta wersja nie jest dostarczana z żadnym wsparciem i aktualizacjami, zachowaj ostrożność przy wykonywaniu ważnych zadań',

  // Original text: "Connect PIF"
  connectPif: 'Połącz PIF',

  // Original text: "Are you sure you want to connect this PIF?"
  connectPifConfirm: 'Jesteś pewien że chcesz się połączyć z tym PIF?',

  // Original text: "Disconnect PIF"
  disconnectPif: 'Rozłącz PIF',

  // Original text: "Are you sure you want to disconnect this PIF?"
  disconnectPifConfirm: 'Jesteś pewien że chcesz się rozłączyć z tym PIF?',

  // Original text: "Delete PIF"
  deletePif: 'Usuń PIF',

  // Original text: "Are you sure you want to delete this PIF?"
  deletePifConfirm: 'Jesteś pewien że chcesz usunąć tego PIF?',
